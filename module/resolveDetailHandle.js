...
const resolveQuery = _loadQuery('resolveQuery')
...
module.exports = async function (websiteId, detailId) {
    ...
    const aboutDetail = await resolveQuery.getDetail(detailId)

    const allAbout = resolveQuery.getAllAbout(aboutDetail.categoryId)
